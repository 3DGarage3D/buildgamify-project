...
const QRCodeRFID = lazy(() => import("./pages/QRCodeRFID"));
  ...
  return (
    <QueryClientProvider client={queryClient}>
      <ThemeProvider>
        <BrowserRouter>
          <TooltipProvider>
            <div className="flex flex-col min-h-screen w-full bg-gray-50 dark:bg-gray-900 transition-colors">
              <Navbar />
              <main className="flex-1 w-full max-w-full sm:max-w-7xl mx-auto p-3 md:p-6 lg:p-8 overflow-x-hidden">
                <Suspense fallback={<div className="flex items-center justify-center h-[60vh]"><div className="animate-pulse-subtle text-muted-foreground">Carregando...</div></div>}>
                  <Routes>
                    ...
                    <Route path="/qr-rfid" element={<PageTransition><QRCodeRFID /></PageTransition>} />
