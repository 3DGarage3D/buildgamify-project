...
const Navbar = () => {
  ...
  return <header className="sticky top-0 z-40 w-full border-b backdrop-blur bg-slate-50">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-80">
              ...
              <div className="max-h-[300px] overflow-y-auto">
                {[1, 2, 3].map(item => <DropdownMenuItem key={item} className="flex flex-col items-start py-2 cursor-pointer">
